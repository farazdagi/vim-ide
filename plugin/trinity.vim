...
function! <SID>Trinity_InitTagList()
    ...
    " Make sure that taglist window gains focus
...
function! <SID>Trinity_Toggle()
    ...
    if s:Trinity_tabPage == 0 let s:Trinity_tabPage = tabpagenr() endif if s:Trinity_tabPage != tabpagenr() echohl ErrorMsg echo "Trinity: Not support multiple tab pages for now." echohl None return endif
